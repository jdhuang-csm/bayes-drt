function Zhat=blockingDDT(w,betak,tl,Fl)

% ZHAT = BLOCKINGDDT(BETAK,TL,FL) predicts impedance using a blocking
% planar distribution of diffusion time model. 
% 
% input:
% (1) w: size: Jx1
%        class: double
...
K1=sqrt(1i*wtet1)./coth(sqrt(1i*wtet1));
