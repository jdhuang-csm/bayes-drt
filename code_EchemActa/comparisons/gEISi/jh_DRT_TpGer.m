function Zhat = jh_DRT_TpGer(w,betak,tl,Fl)
...
% calculate Gerischer-type TP-DDT argument
kjw = (k_ct + 1i*w);
wtet2=bsxfun(@times,kjw,exp(tl{2}));
...
% Tp-DDT with charge transfer kernel
