...
transformed parameters {
	...
	vector[2*N] Y_hat = A*x;
	vector[2*N] Y_hat_re = Y_hat[1:N];
	vector[2*N] Y_hat_im = Y_hat[N+1:2*N];
	vector[2*N] Z_hat_p = append_row(Y_hat_re ./ (square(Y_hat_re) + square(Y_hat_im)), -Y_hat_im ./ (square(Y_hat_re) + square(Y_hat_im)));
	vector[2*N] Z_hat = Z_hat_p + Rinf*Rinf_vec + induc*induc_vec;
